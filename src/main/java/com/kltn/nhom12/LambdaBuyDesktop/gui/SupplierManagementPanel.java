...
import com.kltn.nhom12.LambdaBuyDesktop.action.SupplierManagementController;

public class SupplierManagementPanel extends JPanel {
	 /**
     * Creates new form QLNguoidungPanel
     */
    public SupplierManagementPanel(String token){
        initComponents();
        
        SupplierManagementController controller = new SupplierManagementController(jpnView, btnAdd, btnSub, jtfSearch, token);
