...
public class UserManagementController {
	...
	private ProfileWebService profileWebService = null;
	...
	public UserManagementController(JPanel jpnView, JButton btnAdd, JButton btnSub, JTextField jtfSearch) {
		...
		profileWebService = new ProfileWebService();
	}
	
	public void setDataToTable() {
		try {
			List<UserResponseDto> listItem = userWebService.getAllUser();
	...
	public void setEvent() {
		btnAdd.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				UserFrm frame = null;
				frame = new UserFrm(new UserResponseDto());
				frame.setTitle("Thông tin người dùng");
				frame.setLocationRelativeTo(null);
				frame.setResizable(false);
				frame.setVisible(true);
